...
@section('content')
	...
	<hr>
	{{ Form::open(array('url' => 'veiculo/' . $veiculo->id, 'method' => 'put', 'class' => 'form-horizontal row', 'role' => 'form')) }}

		<div class="col-xs-5 {{ $errors->first('modelo') ? 'has-error' : '' }}">
			{{ Form::label('modelo', '* Modelo', array('class' => 'control-label')) }}
        	{{ Form::text('modelo', Input::old('modelo', $veiculo->modelo), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-7 {{ $errors->first('proprietario') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('proprietario', Input::old('proprietario', $veiculo->proprietario), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('placa') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('placa', Input::old('placa', $veiculo->placa), array('data-mask' => 'AAA-9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('ano') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('ano', Input::old('ano', $veiculo->ano), array('data-mask' => '9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('quilometragem') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('quilometragem', Input::old('quilometragem', $veiculo->quilometragem), array('data-mask' => '#', 'data-mask-reverse' => 'true', 'data-mask-maxlength' => 'false', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('combustivel') ? 'has-error' : '' }}">
			...
			{{ Form::select('combustivel', Veiculo::combustiveis(), Input::old('combustivel', $veiculo->combustivel), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('marca') ? 'has-error' : '' }}">
			...
			{{ Form::select('marca', Veiculo::marcas(), Input::old('marca', $veiculo->marca), array('class' => 'form-control select2', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('chassi') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('chassi', Input::old('chassi', $veiculo->chassi), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('data_cotacao') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_cotacao', Input::old('data_cotacao', Util::toView($veiculo->data_cotacao)), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-3 {{ $errors->first('preco') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('preco', Input::old('preco', $veiculo->preco), array('data-mask' => '###0.00', 'data-mask-reverse' => 'true', 'data-mask-maxlength' => 'false', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-xs-12 pull-left {{ $errors->first('descricao') ? 'has-error' : '' }}">
        	...
        	{{ Form::textarea('descricao', Input::old('descricao', $veiculo->descricao), array('class' => 'form-control')) }}
